...
def perception_step(Rover):
    ...
    obstacle_x_world, obstacle_y_world = pix_to_world(obstacle_x_rover, obstacle_y_rover, xpos, ypos, yaw, world_size,
                                                      scale)
    rock_x_world, rock_y_world = pix_to_world(rock_x_rover, rock_y_rover, xpos, ypos, yaw, world_size, scale)
    navigable_x_world, navigable_y_world = pix_to_world(navigable_x_rover, navigable_y_rover, xpos, ypos, yaw,
                                                        world_size, scale)
